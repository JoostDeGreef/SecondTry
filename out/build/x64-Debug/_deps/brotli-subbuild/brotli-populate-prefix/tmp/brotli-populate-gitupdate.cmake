...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v1.0.9"
  WORKING_DIRECTORY "C:/Src/SecondTry/out/build/x64-Debug/src/3rdParty/brotli-build"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.0.9" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v1.0.9")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Src/SecondTry/out/build/x64-Debug/src/3rdParty/brotli-build'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Src/SecondTry/out/build/x64-Debug/src/3rdParty/brotli-build'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
