...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v1.2.13"
  WORKING_DIRECTORY "C:/Src/SecondTry/out/build/x64-Debug/src/3rdParty/zlib-build"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Src/SecondTry/out/build/x64-Debug/src/3rdParty/zlib-build'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Src/SecondTry/out/build/x64-Debug/src/3rdParty/zlib-build'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
